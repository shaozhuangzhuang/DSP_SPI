...
const struct PIE_VECT_TABLE PieVectTableInit = {
    ...
    PIE_RESERVED_ISR,             // 1.13 - Reserved (IPC0 removed)
    PIE_RESERVED_ISR,             // 1.14 - Reserved (IPC1 removed)
    PIE_RESERVED_ISR,             // 1.15 - Reserved (IPC2 removed)
    PIE_RESERVED_ISR,             // 1.16 - Reserved (IPC3 removed)
