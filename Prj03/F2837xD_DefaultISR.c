...
// 注意：DMA_CH1_ISR已在Drivers/drv_dma.c中实现，这里注释掉默认实现
/*
...
// 注意：DMA_CH2_ISR已在Drivers/drv_dma.c中实现，这里注释掉默认实现
/*
...
// 注意：DMA_CH5_ISR已在Drivers/drv_dma.c中实现，这里注释掉默认实现
/*
...
// 注意：DMA_CH6_ISR已在Drivers/drv_dma.c中实现，这里注释掉默认实现
/*
...
interrupt void SCIC_TX_ISR(void)
{
    ...
    // Insert ISR Code here
    if(TX_number * 16 <  TX_A.len)
    {

        for (i = 0; i < 16; i++)
        {
            if(i + TX_number * 16 < TX_A.len)
                ScicRegs.SCITXBUF.all = TX_A.buf[i + TX_number * 16];
            else
                break;
        }
...
interrupt void SCID_TX_ISR(void)
{
    ...
    if(TX_number * 16 <  TX_A.len)
    {
        ...
        {
            if(i + TX_number * 16 < TX_A.len)
                ScidRegs.SCITXBUF.all = TX_A.buf[i + TX_number * 16];
            else
                break;
        }
...
interrupt void SCIA_TX_ISR(void)
{
    ...
    if(TX_number * 16 <  TX_A.len)
    {
        ...
        {
            if(i + TX_number * 16 < TX_A.len)
                SciaRegs.SCITXBUF.all = TX_A.buf[i + TX_number * 16];
            else
                break;
        }
...
interrupt void SCIB_TX_ISR(void)
{
    ...
    if(TX_number * 16 <  TX_A.len)
    {
        ...
        {
            if(i + TX_number * 16 < TX_A.len)
                ScibRegs.SCITXBUF.all = TX_A.buf[i + TX_number * 16];
            else
                break;
        }
