...
//Low-level functions for GPIO configuration (CPU1 only)
	...
	void Gpioselect()
	{
        ...
        GpioCtrlRegs.GPBDIR.bit.GPIO37 = 1;       // Configure as test
//#ifdef _DSP_SOM

        GPIO_SetupPinMux(94,GPIO_MUX_CPU1,0);     // DE_A
        GPIO_SetupPinOptions(94, GPIO_INPUT,GPIO_SYNC);         //以前是0
        GPIO_SetupPinMux(7,GPIO_MUX_CPU1,0);     // /RE_A
        GPIO_SetupPinOptions(7, GPIO_INPUT,GPIO_SYNC);


        GPIO_SetupPinMux(167,GPIO_MUX_CPU1,0);     // DE_B
        GPIO_SetupPinOptions(167, GPIO_INPUT,GPIO_SYNC);
        GPIO_SetupPinMux(168,GPIO_MUX_CPU1,0);     // /RE_B
        GPIO_SetupPinOptions(168, GPIO_INPUT,GPIO_SYNC);

        GPIO_SetupPinMux(66,GPIO_MUX_CPU1,0);     // DE_C  71->66
        GPIO_SetupPinOptions(66, GPIO_INPUT,GPIO_SYNC);
        GPIO_SetupPinMux(67,GPIO_MUX_CPU1,0);     // /RE_C  74->67
        GPIO_SetupPinOptions(67, GPIO_INPUT,GPIO_SYNC);
#ifdef NODE_MASTER
        GPIO_SetupPinMux(64,GPIO_MUX_CPU1,0);     // DE_D
        GPIO_SetupPinOptions(64, GPIO_INPUT,GPIO_SYNC);
        GPIO_SetupPinMux(65,GPIO_MUX_CPU1,0);     // /RE_D
        GPIO_SetupPinOptions(65, GPIO_INPUT,GPIO_SYNC);
#endif
        GPIO_SetupPinMux(115,GPIO_MUX_CPU1,0);     // LED1
        GPIO_SetupPinOptions(115, GPIO_OUTPUT,GPIO_SYNC);
        GPIO_SetupPinMux(116,GPIO_MUX_CPU1,0);     // LED2
        GPIO_SetupPinOptions(116, GPIO_OUTPUT,GPIO_SYNC);
//
        GPIO_SetupPinMux(147,GPIO_MUX_CPU1,0);     // 给FPGA的脉冲信号，类似看门狗
        GPIO_SetupPinOptions(147, GPIO_OUTPUT,0);

//        GPIO_SetupPinMux(10,GPIO_MUX_CPU1,0);     // 20210923-szz
//        GPIO_SetupPinOptions(10, GPIO_OUTPUT,0);
//        GPIO_SetupPinMux(26,GPIO_MUX_CPU1,0);     // GPIO26
//        GPIO_SetupPinOptions(26, GPIO_OUTPUT,0);
//        GPIO_SetupPinMux(3,GPIO_MUX_CPU1,0);     // GPIO3
//        GPIO_SetupPinOptions(3, GPIO_OUTPUT,0);
//#endif

#ifdef _DSP_C
        GPIO_SetupPinMux(40,GPIO_MUX_CPU1,0);     // DE_A
        GPIO_SetupPinOptions(40, GPIO_OUTPUT,1);
        GPIO_SetupPinMux(41,GPIO_MUX_CPU1,0);     // /RE_A
        GPIO_SetupPinOptions(41, GPIO_OUTPUT,0);

        GPIO_SetupPinMux(56,GPIO_MUX_CPU2,0);     // DE_B
        GPIO_SetupPinOptions(56, GPIO_OUTPUT,0);
        GPIO_SetupPinMux(57,GPIO_MUX_CPU2,0);     // /RE_B
        GPIO_SetupPinOptions(57, GPIO_OUTPUT,0);

        GPIO_SetupPinMux(58,GPIO_MUX_CPU1,0);     // DE_C
        GPIO_SetupPinOptions(58, GPIO_OUTPUT,0);
        GPIO_SetupPinMux(60,GPIO_MUX_CPU1,0);     // /RE_C
        GPIO_SetupPinOptions(60, GPIO_OUTPUT,0);

        GPIO_SetupPinMux(68,GPIO_MUX_CPU2,0);     // DE_D
        GPIO_SetupPinOptions(68, GPIO_OUTPUT,0);
        GPIO_SetupPinMux(69,GPIO_MUX_CPU2,0);     // /RE_D
        GPIO_SetupPinOptions(69, GPIO_OUTPUT,0);

        GPIO_SetupPinMux(33,GPIO_MUX_CPU1,0);     // LED1
        GPIO_SetupPinOptions(33, GPIO_OUTPUT,0);
        GPIO_SetupPinMux(34,GPIO_MUX_CPU2,0);     // LED2
