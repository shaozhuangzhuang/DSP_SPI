...
void InitSci(void)
{
    ...
    SciaRegs.SCIFFTX.all=0xE020; // FIFO使能，TXFIFORESET=1，TXFFIENA=1，TXFFIL=0
...
void SCI_TO_Sim()
{
    ...
    SCI_Send_Cnt++;
//
    U16_Data.U16 = SCI_Send_Cnt;
    SCIA_Txdate[2] = U16_Data.BYTE.Byte_0;
    SCIA_Txdate[3] = U16_Data.BYTE.Byte_1;
